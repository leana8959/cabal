...
import Distribution.Fields.Field                   (Field, Name, FieldLine, SectionArg, FieldTrivia, WithFieldTrivia)
...
instance (ToExpr ann) => ToExpr (FieldTrivia ann)
instance (ToExpr ann) => ToExpr (WithFieldTrivia ann)
